...
export default function HeroContent() {
  ...
  if (!isMounted) {
    return (
      <div className='relative z-10 flex flex-col items-center w-full max-w-6xl space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-7 px-2 pt-2 sm:px-4'>
  ...
  return (
    <div className='relative z-10 flex flex-col items-center w-full max-w-6xl space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-7 px-2 sm:px-4'>
      <AnimatedButton />
      <AnimatedTitle />
